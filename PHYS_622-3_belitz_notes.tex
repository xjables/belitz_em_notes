...
DEBUGGING
\begin{defn}
\label{def:debugging}DEBUGGING
\end{defn}
DEBUGGING \cref{def:debugging}
\begin{defn}
...
\end{eqnarray*}
 As per \cref{def:3_1_tensor_field}, the Levi-Civita tensor constitutes
a pseudo-tensor field:
\[
...
\end{example}
\begin{prop}
Under the conditions of \cref{def:distribution_limit}, we have\renewcommand{\labelenumi}{(\roman{enumi})}
\begin{enumerate}
...
\item Inserted \cref{lem:e_to_the_stuff,lem:cos_times_e}. Arguments of
the Bessel functions are $kR\sin\theta$.
