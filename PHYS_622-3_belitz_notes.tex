...
\end{minipage}
\end{rem}
\ From Chapter 1, §\ref{sub:ch1sec3_4Minkowski-tensors}, we can
write $A^{\mu}$ in the form
\[
...
\]
 From the proposition in §\ref{sub:ch5sec2_1The-concept-of}, the
...
the expansion from §\ref{sub:ch5sec3_1Asymptotic-potentials-and}
applies:
\[
...
From §\ref{sub:ch5sec4_3The-spectral-distribution}, the spectral
